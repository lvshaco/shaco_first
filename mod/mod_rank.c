...
static void
_handle_redis(struct module *s, struct UM_REDISREPLY *rep, int sz) {
    struct rank *self = MODULE_SELF;
...
void
rank_main(struct module *s, int session, int source, int type, const void *msg, int sz) {
    switch (type) {
    case MT_UM: {
